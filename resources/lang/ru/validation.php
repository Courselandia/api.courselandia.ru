...
return [
    ...
    */
    ...
    'exists_soft' => 'Выбранное значение для :attribute некорректно.',
    ...
    'ipv4' => 'Поле :attribute должно быть действительным IPv4-адресомaf.',
    ...
    'float' => 'Значение поле :attribute должно быть дробеным числом.',
    'date_mongo' => 'Значение поле :attribute не валидная дата.',
    'phone' => 'Значение поле :attribute должно быть номером телефона.',
    'float_between' => 'Значение поле :attribute должен быть между :min и :max.',
    'ip_mask' => 'Значение поле :attribute должно соотвествовать IP маске.',
    'media' => 'Значение поле :attribute должно быть изображением в одном из форматов :formats.',
    'path' => 'Значение поле :attribute должен быть коректным путем к файлу.',
    'ids' => 'Значение поле :attribute должно быть списком из ID значений.',
    'sorts' => 'Значение поле :attribute должно быть корректным параметром сортировки, что содержит массив: {field_1: ASC, field_2: DESC, ...}. Допустимые поля для сортировки: :fields.',
    'filters' => 'Значение поле :attribute должно быть корректным параметром фильтрации, что содержит массив: {field_1: value, field_2: value, ...}. Допустимые поля для фильтрации: :fields.',
    'filter_date_range' => 'Значение поле :attribute должно содержать массив из двух дат для полей :fields в формате Y-m-d O. Дата начала должна быть ранее даты окончания.',
    'filter_date' => 'Значение поле :attribute должно содержать дату для полей :fields в формате Y-m-d.',
