...
class SkillTextTask extends Task
{
    ...
    public function run(Carbon $delay = null): void
    {
        ...
        foreach ($skills as $skill) {
            ...
            $job = ArticleRewriteTextJob::dispatch($article->id, 'skill.text', $article->text, $this->creative);
    ...
    {
        return Skill::whereHas('articles', function ($query) {
        ...
        ->with('articles', function ($query) {
            $query->where('category', 'skill.text');
        })
