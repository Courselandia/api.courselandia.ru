...
/**
 * Переписывание текстов для описания раздела.
 */
class SectionTextTask extends Task
{
    ...
    public function run(Carbon $delay = null): void
    {
        ...
        foreach ($sections as $section) {
            ...
            $job = ArticleRewriteTextJob::dispatch($article->id, 'section.text', $article->text, $this->creative);
    ...
    {
        return Section::whereHas('articles', function ($query) {
        ...
        ->with('articles', function ($query) {
            $query->where('category', 'section.text');
        })
