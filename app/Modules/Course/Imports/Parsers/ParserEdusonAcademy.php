 ...
 */
class ParserEdusonAcademy extends ParserYml
{
    /**
     * Вернет школу.
     *
    ...
    {
        return [
            'Бухгалтерия' => Direction::BUSINESS,
            'Excel' => Direction::OTHER,
            'HR' => Direction::OTHER,
            'Управление и бизнес' => Direction::BUSINESS,
            'Маркетинг' => Direction::MARKETING,
            'Профессии на удаленке' => Direction::OTHER,
            'Продажи' => Direction::BUSINESS,
            'Soft-Skills' => Direction::OTHER,
            'Популярные курсы' => Direction::OTHER,
            'IT' => Direction::OTHER,
    ...
    public function read(): Generator
    {
        foreach ($this->getOffers() as $offer) {
            ...
            if (isset($offer['params']['Ежемесячная цена по скидке']['value']) && $offer['params']['Ежемесячная цена по скидке']['value']) {
                $course->price_recurrent = $offer['params']['Ежемесячная цена по скидке']['value'];
            }
