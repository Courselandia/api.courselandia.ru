...
use App\Modules\Course\Json\Jobs\SchoolItemLinkJob;
 ...
 */
class SchoolSource extends Source
{
    /**
    ...
    public function export(): void
    {
        ...
        for ($i = 0; $i <= $count; $i++) {
            ...
            if ($result) {
                SchoolItemLinkJob::dispatch('/json/schools/' . $result['link'] . '.json', $result['id'], $result['link'])
                    ->delay(now()->addMinute());
