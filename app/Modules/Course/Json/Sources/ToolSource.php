...
use App\Modules\Course\Json\Jobs\ToolItemLinkJob;
 ...
 */
class ToolSource extends Source
{
    /**
    ...
    public function export(): void
    {
        ...
        for ($i = 0; $i <= $count; $i++) {
            ...
            if ($result) {
                ToolItemLinkJob::dispatch('/json/tools/' . $result['link'] . '.json', $result['id'], $result['link'])
                    ->delay(now()->addMinute());
