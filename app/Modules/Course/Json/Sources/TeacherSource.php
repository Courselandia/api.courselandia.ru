...
use App\Modules\Course\Json\Jobs\TeacherItemLinkJob;
 ...
 */
class TeacherSource extends Source
{
    /**
    ...
    public function export(): void
    {
        ...
        for ($i = 0; $i <= $count; $i++) {
            ...
            if ($result) {
                TeacherItemLinkJob::dispatch('/json/teachers/' . $result['link'] . '.json', $result['id'], $result['link'])
                    ->delay(now()->addMinute());
