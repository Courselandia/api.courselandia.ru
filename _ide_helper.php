...
')
     ...
     */ 
        ...
        {
                        return \App\Models\Util::iconv($arString, $from, $to);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getText($string);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getTextN($string);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getTextBr($string);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getHtmlBr($string);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getHtmlN($string);
        }
                    /**
         ...
         * @static 
         */ 
        public static function parserBrToRn($string)
        {
                        return \App\Models\Util::parserBrToRn($string);
        }
                    /**
        ...
        {
                        return \App\Models\Util::parserRnToBr($str);
        }
                    /**
        ...
        {
                        return \App\Models\Util::deleteWhitespace($string);
        }
                    /**
         * Транслирует текст.
         * 
        ...
        {
                        return \App\Models\Util::latin($string, $separator, $symbols);
        }
                    /**
        ...
        {
                        return \App\Models\Util::isAssoc($arr);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getKey(...$params);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getNumber($number, $digits);
        }
                    /**
        ...
        {
                        return \App\Models\Util::getMoney($number, $digits, $label, $beginning);
        }
                    /**
     ...
     */ 
         ...
         * Типографирование текста.
         *
         * @param \App\Models\Typography\?string $text Текст для тпиографирования.
         * @param bool $htmlEntityDecode Преобразует HTML-сущности в соответствующие им символы.
         * @return \App\Models\Typography\?string Оттипографированный текст.
         * @static 
         */ 
        public static function process($text, $htmlEntityDecode = false)
        {
                        /** @var \App\Models\Typography\Typography $instance */
                        return $instance->process($text, $htmlEntityDecode);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function operationSystem()
        {
                        /** @var \App\Models\Device $instance */
                        return $instance->operationSystem();
        }
                    /**
     ...
     */ 
        ...
        {
                        /** @var \App\Modules\Alert\Models\AlertImplement $instance */
                        return $instance->setStatus($id, $status);
        }
                    /**
        ...
        {
                        /** @var \App\Modules\Alert\Models\AlertImplement $instance */
                        return $instance->list($offset, $limit, $status);
        }
     ...
     */ 
        ...
        public static function connection($name = null)
        {
                        /** @var \MailerLite\LaravelElasticsearch\Manager $instance */
                        return $instance->connection($name);
        }
                    /**
...
namespace  { 
            ...
            class Elasticsearch extends \MailerLite\LaravelElasticsearch\Facade {}
